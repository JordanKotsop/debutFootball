      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col items-start md:items-end gap-4">
            ...
            {/* FIFA Badge */}
            <span className="inline-block bg-debut-gold/10 border border-debut-gold/25 px-3 py-1.5 rounded font-body font-medium text-[10px] tracking-[0.10em] uppercase text-debut-gold/80 mt-2">
