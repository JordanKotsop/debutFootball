    ...
    <section id="contact" className="relative bg-debut-off-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32">
        <div className="max-w-[720px] mx-auto text-center">
          {/* Divider */}
          <div className="w-16 h-px bg-debut-accent mx-auto mb-6 sm:mb-8" />
          ...
          <motion.p
            ...
            className="font-body text-base sm:text-lg text-debut-text-muted leading-[1.7] max-w-[520px] mx-auto mb-8 sm:mb-10"
          >
            Player, parent, or coach — we&apos;re here to help you think it
            through.
          </motion.p>
          ...
          >
            <a
              ...
              className="inline-block bg-debut-navy text-white font-semibold text-sm sm:text-base tracking-wide uppercase px-8 sm:px-12 py-3.5 sm:py-4 rounded-md hover:bg-debut-navy-mid hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 min-h-[44px]"
            >
              Contact Us
            </a>
          </motion.div>
          ...
          >
            ...
            <p className="font-body text-sm text-debut-text-muted">
              ...
              <a
                ...
                className="text-debut-accent hover:text-debut-accent-light transition-colors duration-150 min-h-[44px] inline-flex items-center"
              >
                LinkedIn &rarr;
              </a>
            </p>
          ...
          {/* Legal Line */}
          <p className="font-body text-[11px] sm:text-xs text-debut-text-muted/40 mt-6 sm:mt-8">
